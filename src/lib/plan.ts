...
export const PLAN: Record<number, PlanDay> = {
  1:{label:"Monday", focus:"Chest + Back", gym:{from:"19:00",to:"20:30"}, slots:[
    ...
    {id:"l",  time:"13:00", name:"Lunch", tone:"leaf", items:[
      P(0,"Rice + quinoa, 1 cup cooked",215,6,"🍚"), P(0,"Chicken curry, 150g",300,38,"🍗"), P(0,"Dal, 1 katori",140,8,"🫘"),
  ...
  2:{label:"Tuesday", focus:"Biceps + Triceps", gym:{from:"19:00",to:"20:30"}, slots:[
    ...
    {id:"l",  time:"13:00", name:"Lunch", tone:"leaf", items:[
      P(0,"Rice + quinoa, 1 cup cooked",215,6,"🍚"), P(0,"Fish curry, 180g",300,38,"🐟"), P(0,"Rasam",60,2,"🍲"),
  ...
  3:{label:"Wednesday", focus:"Legs + Abs", gym:{from:"19:00",to:"20:30"}, slots:[
    ...
    {id:"l",  time:"13:00", name:"Lunch", tone:"leaf", items:[
      P(0,"Rice + quinoa, 1 cup cooked",215,6,"🍚"), P(0,"Egg curry, 3 eggs",330,21,"🍛"), P(0,"Dal, 1 katori",140,8,"🫘"),
  ...
  4:{label:"Thursday", focus:"Shoulders + Back", gym:{from:"19:00",to:"20:30"}, slots:[
    ...
    {id:"l",  time:"13:00", name:"Lunch", tone:"leaf", items:[
      P(0,"Rice + quinoa, 1 cup cooked",215,6,"🍚"), P(0,"Chicken curry, 150g",300,38,"🍗"),
  ...
  6:{label:"Saturday", focus:"Rest day", gym:null, slots:[
    ...
    {id:"l",  time:"13:00", name:"Lunch", tone:"leaf", items:[
      P(0,"Rice + quinoa, 1 cup cooked",215,6,"🍚"), P(0,"Goat curry, 120g",330,28,"🍛"), P(0,"Rasam",60,2,"🍲"),
  ...
  0:{label:"Sunday", focus:"Optional gym", gym:{from:"18:30",to:"20:00"}, slots:[
    ...
    {id:"l",  time:"13:00", name:"Lunch", tone:"leaf", items:[
      P(0,"Rice + quinoa, 1 cup cooked",215,6,"🍚"), P(0,"Chicken pepper fry, 150g",300,38,"🍗"),
